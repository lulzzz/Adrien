...
namespace Compute.Bindings
{
    ...
    {
        /*
        [Option("int8", Required = false, HelpText = "Map int8_t or byte types to the specified .NET type.", SetName = "type")]
        public string Int8 { get; set; }

        [Option("char", Required = false, HelpText = "Map char types to the specified .NET type.", SetName = "type")]
        public string Char { get; set; }

        [Option("int16", Required = false, HelpText = "Map int16_t or short integer types to the specified .NET type.", SetName = "type")]
        public string Int16 { get; set; }

        [Option("int32", Required = false, HelpText = "Map int32_t or integer types to the specified .NET type.", SetName = "type")]
        public string Int32 { get; set; }

        [Option("int64", Required = false, HelpText = "Map int64_t or long integer types to the specified .NET type.", SetName = "type")]
        public string Int64 { get; set; }

        [Option("float", Required = false, HelpText = "Map float or single-precision floating point types to the specified .NET type.", SetName = "type")]
        public string Float { get; set; }

        [Option("double", Required = false, HelpText = "Map double-precision floating point type to the specified .NET type.", SetName = "type")]
    ...
    [Verb("lpsolve", HelpText = "Generate bindings for the lp_solve library.")]
    class LpSolveOptions : Options
    {
        public LpSolveOptions()
        {
            ModuleName = "all";
        }

        [Option("internal-blas", Required = false, HelpText = "Use the lp_solve internal BLAS solver.")]
        public bool UseInternalBlasLibrary
        {
            get; set;
        }

        [Option("blas-library", Required = false, HelpText = "Use the specified external BLAS library")]
        public string ExternalBlasLibrary { get; set; }
